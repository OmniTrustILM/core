...
public enum FilterField {
    ...
    SERIAL_NUMBER(Resource.CERTIFICATE, null, null, Certificate_.serialNumber, "Serial Number",
            SearchFieldTypeEnum.STRING),
    RA_PROFILE_NAME(Resource.CERTIFICATE, Resource.RA_PROFILE, List.of(Certificate_.raProfile), RaProfile_.name,
            "RA Profile", SearchFieldTypeEnum.LIST, null, null, true, null),
    CERTIFICATE_TYPE(Resource.CERTIFICATE, null, null, Certificate_.certificateType, "Type", SearchFieldTypeEnum.LIST,
            CertificateType.class),
    CERTIFICATE_STATE(Resource.CERTIFICATE, null, null, Certificate_.state, Constants.STATE, SearchFieldTypeEnum.LIST,
            CertificateState.class),
    CERTIFICATE_VALIDATION_STATUS(Resource.CERTIFICATE, null, null, Certificate_.validationStatus, "Validation status",
            SearchFieldTypeEnum.LIST, CertificateValidationStatus.class),
    COMPLIANCE_STATUS(Resource.CERTIFICATE, null, null, Certificate_.complianceStatus, "Compliance Status",
            SearchFieldTypeEnum.LIST, ComplianceStatus.class),
    GROUP_NAME(Resource.CERTIFICATE, Resource.GROUP, List.of(Certificate_.groups), Group_.name, "Groups",
            SearchFieldTypeEnum.LIST, null, null, true, null),
    CERT_LOCATION_NAME(Resource.CERTIFICATE, Resource.LOCATION,
            List.of(Certificate_.locations, CertificateLocation_.location), Location_.name, "Locations",
            SearchFieldTypeEnum.LIST),
    OWNER(Resource.CERTIFICATE, Resource.USER, List.of(Certificate_.owner), OwnerAssociation_.ownerUsername, "Owner",
            SearchFieldTypeEnum.LIST, null, null, true, null),
    ISSUER_COMMON_NAME(Resource.CERTIFICATE, null, null, Certificate_.issuerCommonName, "Issuer Common Name",
            SearchFieldTypeEnum.STRING),
    SIGNATURE_ALGORITHM(Resource.CERTIFICATE, null, null, Certificate_.signatureAlgorithm, "Signature Algorithm",
            SearchFieldTypeEnum.LIST),
    ALT_SIGNATURE_ALGORITHM(Resource.CERTIFICATE, null, null, Certificate_.altSignatureAlgorithm,
            "Alternative Signature Algorithm", SearchFieldTypeEnum.LIST),
    ...
    PUBLIC_KEY_ALGORITHM(Resource.CERTIFICATE, null, null, Certificate_.publicKeyAlgorithm, "Public Key Algorithm",
            SearchFieldTypeEnum.LIST),
    ALT_PUBLIC_KEY_ALGORITHM(Resource.CERTIFICATE, null, null, Certificate_.altPublicKeyAlgorithm,
            "Alternative Public Key Algorithm", SearchFieldTypeEnum.LIST),
    KEY_SIZE(Resource.CERTIFICATE, null, null, Certificate_.keySize, "Key Size", SearchFieldTypeEnum.LIST),
    ALT_KEY_SIZE(Resource.CERTIFICATE, null, null, Certificate_.altKeySize, "Alternative Key Size",
            SearchFieldTypeEnum.LIST),
    ...
    SUBJECT_ALTERNATIVE_NAMES(Resource.CERTIFICATE, null, null, Certificate_.subjectAlternativeNames,
            "Subject Alternative Name", SearchFieldTypeEnum.STRING),
    ...
    ISSUER_SERIAL_NUMBER(Resource.CERTIFICATE, null, null, Certificate_.issuerSerialNumber, "Issuer Serial Number",
            SearchFieldTypeEnum.STRING),
    OCSP_VALIDATION(Resource.CERTIFICATE, null, null, Certificate_.certificateValidationResult, "OCSP Validation",
            SearchFieldTypeEnum.LIST, CertificateValidationStatus.class),
    CRL_VALIDATION(Resource.CERTIFICATE, null, null, Certificate_.certificateValidationResult, "CRL Validation",
            SearchFieldTypeEnum.LIST, CertificateValidationStatus.class),
    SIGNATURE_VALIDATION(Resource.CERTIFICATE, null, null, Certificate_.certificateValidationResult,
            "Signature Validation", SearchFieldTypeEnum.LIST, CertificateValidationStatus.class),
    PRIVATE_KEY(Resource.CERTIFICATE, Resource.CRYPTOGRAPHIC_KEY, List.of(Certificate_.key, CryptographicKey_.items),
            CryptographicKeyItem_.type, "Has private key", SearchFieldTypeEnum.BOOLEAN, null, KeyType.PRIVATE_KEY,
            false, null),
    TRUSTED_CA(Resource.CERTIFICATE, null, null, Certificate_.trustedCa, "Trusted CA", SearchFieldTypeEnum.BOOLEAN),
    CERTIFICATE_PROTOCOL(Resource.CERTIFICATE, null, List.of(Certificate_.protocolAssociation),
            CertificateProtocolAssociation_.protocol, "Certificate Protocol", SearchFieldTypeEnum.LIST,
            CertificateProtocol.class),
    HYBRID_CERTIFICATE(Resource.CERTIFICATE, null, null, Certificate_.hybridCertificate, "Hybrid Certificate",
    ...
    SUCCEEDING_CERTIFICATES(Resource.CERTIFICATE, null, List.of(Certificate_.successorRelations),
            CertificateRelation_.relationType, "Succeeding Certificates", SearchFieldTypeEnum.LIST,
            CertificateRelationType.class),
    PRECEDING_CERTIFICATES(Resource.CERTIFICATE, null, List.of(Certificate_.predecessorRelations),
            CertificateRelation_.relationType, "Preceding Certificates", SearchFieldTypeEnum.LIST,
            CertificateRelationType.class),
    ACME_PROFILE(Resource.CERTIFICATE, Resource.ACME_PROFILE,
            List.of(Certificate_.protocolAssociation, CertificateProtocolAssociation_.acmeProfile), AcmeProfile_.name,
            "ACME Profile", SearchFieldTypeEnum.LIST),
    SCEP_PROFILE(Resource.CERTIFICATE, Resource.SCEP_PROFILE,
            List.of(Certificate_.protocolAssociation, CertificateProtocolAssociation_.scepProfile), ScepProfile_.name,
            "SCEP Profile", SearchFieldTypeEnum.LIST),
    CMP_PROFILE(Resource.CERTIFICATE, Resource.CMP_PROFILE,
            List.of(Certificate_.protocolAssociation, CertificateProtocolAssociation_.cmpProfile), CmpProfile_.name,
            "CMP Profile", SearchFieldTypeEnum.LIST),
    ACME_ACCOUNT(Resource.CERTIFICATE, Resource.ACME_ACCOUNT,
            List.of(Certificate_.protocolAssociation, CertificateProtocolAssociation_.acmeAccount),
            AcmeAccount_.accountId, "ACME Account", SearchFieldTypeEnum.LIST),

    // Certificate Request
    CERT_REQUEST_COMMON_NAME(Resource.CERTIFICATE_REQUEST, null, null, CertificateRequestEntity_.commonName,
            "Common Name", SearchFieldTypeEnum.STRING),
    CERT_REQUEST_CERTIFICATE_TYPE(Resource.CERTIFICATE_REQUEST, null, null, CertificateRequestEntity_.certificateType,
            "Certificate Type", SearchFieldTypeEnum.LIST, CertificateType.class),
    CERT_REQUEST_FORMAT(Resource.CERTIFICATE_REQUEST, null, null, CertificateRequestEntity_.certificateRequestFormat,
            "Format", SearchFieldTypeEnum.LIST, CertificateRequestFormat.class),
    CERT_REQUEST_SUBJECT_DN(Resource.CERTIFICATE_REQUEST, null, null, CertificateRequestEntity_.subjectDn, "Subject DN",
            SearchFieldTypeEnum.STRING),
    CERT_REQUEST_PUBLIC_KEY_ALGORITHM(Resource.CERTIFICATE_REQUEST, null, null,
            CertificateRequestEntity_.publicKeyAlgorithm, "Public Key Algorithm", SearchFieldTypeEnum.LIST),
    CERT_REQUEST_ALT_PUBLIC_KEY_ALGORITHM(Resource.CERTIFICATE_REQUEST, null, null,
            CertificateRequestEntity_.altPublicKeyAlgorithm, "Alternative Public Key Algorithm",
            SearchFieldTypeEnum.LIST),
    CERT_REQUEST_SIGNATURE_ALGORITHM(Resource.CERTIFICATE_REQUEST, null, null,
            CertificateRequestEntity_.signatureAlgorithm, "Signature Algorithm", SearchFieldTypeEnum.LIST),
    CERT_REQUEST_ALT_SIGNATURE_ALGORITHM(Resource.CERTIFICATE_REQUEST, null, null,
            CertificateRequestEntity_.altSignatureAlgorithm, "Alternative Signature Algorithm",
            SearchFieldTypeEnum.LIST),
    CERT_REQUEST_COMPLIANCE_STATUS(Resource.CERTIFICATE_REQUEST, null, null, CertificateRequestEntity_.complianceStatus,
            "Compliance Status", SearchFieldTypeEnum.LIST, ComplianceStatus.class),
    CERT_REQUEST_KEY_USAGE(Resource.CERTIFICATE_REQUEST, null, null, CertificateRequestEntity_.keyUsage, "Key Usage",
            SearchFieldTypeEnum.LIST, CertificateKeyUsage.class),
    CERT_REQUEST_SUBJECT_ALTERNATIVE_NAMES(Resource.CERTIFICATE_REQUEST, null, null,
            CertificateRequestEntity_.subjectAlternativeNames, "Subject Alternative Name", SearchFieldTypeEnum.STRING),

    // Cryptographic Key
    CKI_NAME(Resource.CRYPTOGRAPHIC_KEY, null, null, CryptographicKeyItem_.name, "Name", SearchFieldTypeEnum.STRING),
    CKI_TYPE(Resource.CRYPTOGRAPHIC_KEY, null, null, CryptographicKeyItem_.type, "Key type", SearchFieldTypeEnum.LIST,
            KeyType.class, null, false, null),
    CKI_FORMAT(Resource.CRYPTOGRAPHIC_KEY, null, null, CryptographicKeyItem_.format, "Key format",
            SearchFieldTypeEnum.LIST, KeyFormat.class, null, false, null),
    CKI_STATE(Resource.CRYPTOGRAPHIC_KEY, null, null, CryptographicKeyItem_.state, Constants.STATE,
            SearchFieldTypeEnum.LIST, KeyState.class, null, false, null),
    CKI_CRYPTOGRAPHIC_ALGORITHM(Resource.CRYPTOGRAPHIC_KEY, null, null, CryptographicKeyItem_.keyAlgorithm,
            "Cryptographic algorithm", SearchFieldTypeEnum.LIST, KeyAlgorithm.class, null, false, null),
    CKI_USAGE(Resource.CRYPTOGRAPHIC_KEY, null, null, CryptographicKeyItem_.usage, "Key Usage",
    ...
    CK_TOKEN_PROFILE(Resource.CRYPTOGRAPHIC_KEY, Resource.TOKEN_PROFILE,
            ...
            SearchFieldTypeEnum.LIST),
    CK_TOKEN_INSTANCE(Resource.CRYPTOGRAPHIC_KEY, Resource.TOKEN,
            List.of(CryptographicKeyItem_.key, CryptographicKey_.tokenInstanceReference), TokenInstanceReference_.name,
            "Token instance", SearchFieldTypeEnum.LIST),
    CK_GROUP(Resource.CRYPTOGRAPHIC_KEY, Resource.GROUP, List.of(CryptographicKeyItem_.key, CryptographicKey_.groups),
            Group_.name, "Groups", SearchFieldTypeEnum.LIST, null, null, true, null),
    CK_OWNER(Resource.CRYPTOGRAPHIC_KEY, Resource.USER, List.of(CryptographicKeyItem_.key, CryptographicKey_.owner),
    ...
    ENTITY_CONNECTOR_NAME(Resource.ENTITY, null, null, EntityInstanceReference_.connectorName, "Entity provider",
            SearchFieldTypeEnum.LIST),
    ...
    LOCATION_ENTITY_INSTANCE(Resource.LOCATION, null, null, Location_.entityInstanceName, "Entity instance",
            SearchFieldTypeEnum.LIST),
    LOCATION_ENABLED(Resource.LOCATION, null, null, Location_.enabled, Constants.ENABLED, SearchFieldTypeEnum.BOOLEAN),
    LOCATION_SUPPORT_MULTIPLE_ENTRIES(Resource.LOCATION, null, null, Location_.supportMultipleEntries,
            "Support multiple entries", SearchFieldTypeEnum.BOOLEAN),
    LOCATION_SUPPORT_KEY_MANAGEMENT(Resource.LOCATION, null, null, Location_.supportKeyManagement,
            "Support key management", SearchFieldTypeEnum.BOOLEAN),

    // Connector
    CONNECTOR_NAME(Resource.CONNECTOR, null, null, Connector_.name, "Name", SearchFieldTypeEnum.STRING),
    CONNECTOR_VERSION(Resource.CONNECTOR, null, null, Connector_.version, "Version", SearchFieldTypeEnum.LIST,
    ...
    CONNECTOR_FUNCTION_GROUP(Resource.CONNECTOR, null,
            List.of(Connector_.functionGroups, Connector2FunctionGroup_.functionGroup), FunctionGroup_.code,
            "Function group", SearchFieldTypeEnum.LIST, FunctionGroupCode.class),

    // Audit Logs
    AUDIT_LOG_TIMESTAMP(Resource.AUDIT_LOG, null, null, AuditLog_.timestamp, "Timestamp", SearchFieldTypeEnum.DATETIME),
    AUDIT_LOG_MODULE(Resource.AUDIT_LOG, null, null, AuditLog_.module, "Module", SearchFieldTypeEnum.LIST,
            Module.class),
    AUDIT_LOG_ACTOR_TYPE(Resource.AUDIT_LOG, null, null, AuditLog_.actorType, "Actor type", SearchFieldTypeEnum.LIST,
            ActorType.class),
    ...
    AUDIT_LOG_OPERATION_RESULT(Resource.AUDIT_LOG, null, null, AuditLog_.operationResult, "Operation result",
            SearchFieldTypeEnum.LIST, OperationResult.class),
    AUDIT_LOG_SOURCE_IP_ADDRESS(Resource.AUDIT_LOG, null, null, AuditLog_.logRecord, "IP Address",
            SearchFieldTypeEnum.STRING, new String[]{"source", "ipAddress"}),
    AUDIT_LOG_SOURCE_PATH(Resource.AUDIT_LOG, null, null, AuditLog_.logRecord, "API path", SearchFieldTypeEnum.STRING,
            new String[]{"source", "path"}),
    AUDIT_LOG_MESSAGE(Resource.AUDIT_LOG, null, null, AuditLog_.message, "Message", SearchFieldTypeEnum.STRING),
    AUDIT_LOG_RESOURCE_UUID(Resource.AUDIT_LOG, null, null, AuditLog_.logRecord, "Resource UUID",
            SearchFieldTypeEnum.STRING, new String[]{"resource", Constants.RESOURCE_OBJECTS_ARRAY, "uuid"}),
    AUDIT_LOG_RESOURCE_NAME(Resource.AUDIT_LOG, null, null, AuditLog_.logRecord, "Resource Name",
            SearchFieldTypeEnum.STRING, new String[]{"resource", Constants.RESOURCE_OBJECTS_ARRAY, "name"}),
    AUDIT_LOG_AFFILIATED_RESOURCE_UUID(Resource.AUDIT_LOG, null, null, AuditLog_.logRecord, "Affiliated Resource UUID",
            SearchFieldTypeEnum.STRING, new String[]{"affiliatedResource", Constants.RESOURCE_OBJECTS_ARRAY, "uuid"}),
    AUDIT_LOG_AFFILIATED_RESOURCE_NAME(Resource.AUDIT_LOG, null, null, AuditLog_.logRecord, "Affiliated Resource Name",
            SearchFieldTypeEnum.STRING, new String[]{"affiliatedResource", Constants.RESOURCE_OBJECTS_ARRAY, "name"}),

    // Scheduled Job
    SCHEDULED_JOB_NAME(Resource.SCHEDULED_JOB, null, null, ScheduledJob_.jobName, "Job Name",
            SearchFieldTypeEnum.STRING),
    SCHEDULED_JOB_ONE_TIME(Resource.SCHEDULED_JOB, null, null, ScheduledJob_.oneTime, "One Time",
            SearchFieldTypeEnum.BOOLEAN),
    SCHEDULED_JOB_SYSTEM(Resource.SCHEDULED_JOB, null, null, ScheduledJob_.system, "System",
            SearchFieldTypeEnum.BOOLEAN),
    SCHEDULED_JOB_CLASS_NAME(Resource.SCHEDULED_JOB, null, null, ScheduledJob_.jobClassName, "Class Name",
            SearchFieldTypeEnum.LIST),
    ...
    OID_ENTRY_DISPLAY_NAME(Resource.OID, null, null, CustomOidEntry_.displayName, "Display Name",
            SearchFieldTypeEnum.STRING),
    OID_ENTRY_CATEGORY(Resource.OID, null, null, CustomOidEntry_.category, "Category", SearchFieldTypeEnum.LIST,
            OidCategory.class),
    OID_ENTRY_CODE(Resource.OID, null, null, RdnAttributeTypeCustomOidEntry_.code, "Code", SearchFieldTypeEnum.STRING),
    OID_ENTRY_ALT_CODES(Resource.OID, null, null, RdnAttributeTypeCustomOidEntry_.altCodes, "Alt Codes",
    ...
    VAULT_INSTANCE_CONNECTOR_NAME(Resource.VAULT, Resource.CONNECTOR, List.of(VaultInstance_.connector),
            Connector_.name, "Connector Name", SearchFieldTypeEnum.LIST),

    // Vault Profile
    VAULT_PROFILE_NAME(Resource.VAULT_PROFILE, null, null, VaultProfile_.name, "Name", SearchFieldTypeEnum.STRING),
    VAULT_PROFILE_VAULT_INSTANCE(Resource.VAULT_PROFILE, Resource.VAULT, List.of(VaultProfile_.vaultInstance),
            VaultInstance_.name, "Vault Instance", SearchFieldTypeEnum.LIST),
    ...
    SECRET_STATE(Resource.SECRET, null, null, Secret_.state, Constants.STATE, SearchFieldTypeEnum.LIST,
            SecretState.class),
    SECRET_ENABLED(Resource.SECRET, null, null, Secret_.enabled, Constants.ENABLED, SearchFieldTypeEnum.BOOLEAN),
    SECRET_GROUP_NAME(Resource.SECRET, Resource.GROUP, List.of(Secret_.groups), Group_.name, "Groups",
            SearchFieldTypeEnum.LIST, null, null, true, null),
    SECRET_OWNER(Resource.SECRET, Resource.USER, List.of(Secret_.owner), OwnerAssociation_.ownerUsername, "Owner",
            SearchFieldTypeEnum.LIST, null, null, true, null),
    SECRET_COMPLIANCE_STATUS(Resource.SECRET, null, null, Secret_.complianceStatus, "Compliance Status",
            SearchFieldTypeEnum.LIST, ComplianceStatus.class),
    SECRET_SOURCE_VAULT_PROFILE(Resource.SECRET, Resource.VAULT_PROFILE, List.of(Secret_.sourceVaultProfile),
            VaultProfile_.name, "Source Vault Profile", SearchFieldTypeEnum.LIST),
    SECRET_SYNC_VAULT_PROFILE(Resource.SECRET, Resource.VAULT_PROFILE,
            List.of(Secret_.syncVaultProfiles, Secret2SyncVaultProfile_.vaultProfile), VaultProfile_.name,
            "Sync Vault Profile", SearchFieldTypeEnum.LIST),
    ...
    CBOM_ALGORITHMS_COUNT(Resource.CBOM, null, null, Cbom_.algorithmsCount, "Algorithms Count",
            SearchFieldTypeEnum.NUMBER),
    CBOM_CERTIFICATES_COUNT(Resource.CBOM, null, null, Cbom_.certificatesCount, "Certificates Count",
            SearchFieldTypeEnum.NUMBER),
    CBOM_PROTOCOLS_COUNT(Resource.CBOM, null, null, Cbom_.protocolsCount, "Protocols Count",
            SearchFieldTypeEnum.NUMBER),
    ...
    SIGNING_PROFILE_NAME(Resource.SIGNING_PROFILE, null, null, SigningProfile_.name, "Name",
            SearchFieldTypeEnum.STRING),
    SIGNING_PROFILE_ENABLED(Resource.SIGNING_PROFILE, null, null, SigningProfile_.enabled, Constants.ENABLED,
            SearchFieldTypeEnum.BOOLEAN),
    SIGNING_PROFILE_SIGNING_SCHEME(Resource.SIGNING_PROFILE, null, null, SigningProfile_.signingScheme,
            "Signing Scheme", SearchFieldTypeEnum.LIST, SigningScheme.class),
    SIGNING_PROFILE_WORKFLOW_TYPE(Resource.SIGNING_PROFILE, null, null, SigningProfile_.workflowType, "Workflow Type",
            SearchFieldTypeEnum.LIST, SigningWorkflowType.class),
    SIGNING_PROFILE_TSP_PROFILE(Resource.SIGNING_PROFILE, Resource.TSP_PROFILE, List.of(SigningProfile_.tspProfile),
            TspProfile_.name, "TSP Profile", SearchFieldTypeEnum.LIST),
    SIGNING_PROFILE_TIME_QUALITY_CONFIGURATION(Resource.SIGNING_PROFILE, Resource.TIME_QUALITY_CONFIGURATION,
            List.of(SigningProfile_.timeQualityConfiguration), TimeQualityConfiguration_.name,
            "Time Quality Configuration", SearchFieldTypeEnum.LIST),
    ...
    TIME_QUALITY_CONFIGURATION_NAME(Resource.TIME_QUALITY_CONFIGURATION, null, null, TimeQualityConfiguration_.name,
            "Name", SearchFieldTypeEnum.STRING),
    TIME_QUALITY_CONFIGURATION_LEAP_SECOND_GUARD(Resource.TIME_QUALITY_CONFIGURATION, null, null,
            TimeQualityConfiguration_.leapSecondGuard, "Leap Second Guard", SearchFieldTypeEnum.BOOLEAN),
    TIME_QUALITY_CONFIGURATION_NTP_SERVERS_MIN_REACHABLE(Resource.TIME_QUALITY_CONFIGURATION, null, null,
            TimeQualityConfiguration_.ntpServersMinReachable, "NTP Servers Min Reachable", SearchFieldTypeEnum.NUMBER),
    TIME_QUALITY_CONFIGURATION_NTP_SAMPLES_PER_SERVER(Resource.TIME_QUALITY_CONFIGURATION, null, null,
            TimeQualityConfiguration_.ntpSamplesPerServer, "NTP Samples Per Server", SearchFieldTypeEnum.NUMBER),
    ...
    TSP_PROFILE_ENABLED(Resource.TSP_PROFILE, null, null, TspProfile_.enabled, Constants.ENABLED,
            SearchFieldTypeEnum.BOOLEAN),
    TSP_PROFILE_DEFAULT_SIGNING_PROFILE(Resource.TSP_PROFILE, Resource.SIGNING_PROFILE,
            List.of(TspProfile_.defaultSigningProfile), SigningProfile_.name, "Default Signing Profile",
            SearchFieldTypeEnum.LIST),

    // Signing Record
    SIGNING_RECORD_NAME(Resource.SIGNING_RECORD, null, null, SigningRecord_.name, "Name", SearchFieldTypeEnum.STRING),
    SIGNING_RECORD_SIGNING_PROFILE(Resource.SIGNING_RECORD, Resource.SIGNING_PROFILE,
            List.of(SigningRecord_.signingProfile), SigningProfile_.name, "Signing Profile", SearchFieldTypeEnum.LIST),
    SIGNING_RECORD_PROTOCOL(Resource.SIGNING_RECORD, null, null, SigningRecord_.protocol, "Protocol",
            SearchFieldTypeEnum.LIST, SigningProtocol.class),
    SIGNING_RECORD_SIGNING_PROFILE_VERSION(Resource.SIGNING_RECORD, null, null, SigningRecord_.signingProfileVersion,
            "Signing Profile Version", SearchFieldTypeEnum.NUMBER),
    SIGNING_RECORD_SIGNING_TIME(Resource.SIGNING_RECORD, null, null, SigningRecord_.signingTime, "Signing Time",
            SearchFieldTypeEnum.DATETIME),
