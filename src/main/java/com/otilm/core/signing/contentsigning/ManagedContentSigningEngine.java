...
public class ManagedContentSigningEngine {
    ...
    private SignedContent augmentToTargetLevel(AugmentationRequest request, SigningProfileModel<?, ?> signingProfile,
        ...
        // No certificate gate here: this path releases no key of the profile's own scheme, and a signature must stay
        // augmentable after that certificate has lapsed. The referenced TIMESTAMPING profile gates its own key.
