...
/**
 * Wires the bounded in-memory queue that {@link BestEffortSigningRecordWriter} drains. Reading the capacity
 * config here keeps it in one place and lets the writer stay agnostic of it — and lets tests construct the
