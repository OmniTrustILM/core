...
class OutboxSigningRecordWriterTest extends BaseSpringBootTest {
    ...
    void enqueuesIntoOutboxNotIntoSigningRecord() {
        ...
        p.setName("ob"); p.setSigningScheme(SigningScheme.MANAGED);
        p.setWorkflowType(SigningWorkflowType.CONTENT_SIGNING); p.setLatestVersion(1);
        ...
        v.setRecordSignature(true); v.setRecordDtbs(true);
