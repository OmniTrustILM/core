...
class CertificateServiceITest extends BaseSpringBootTest {
    ...
    class Listing {
        ...
        void marksPrivateKeyAvailable_whenKeyPresent() {
            // given
            CryptographicKey key = seedKey(
                    aCryptographicKey().withName("testKey").build(),
        ...
        void filtersCmpSigningCertificates(
            ...
            // then
            assertThat(isPresent).as("Certificate '" + commonName + "' acceptance mismatch").isEqualTo(shouldBeAccepted);
        }
    ...
    class Crud {
        ...
        @Test
        void createsHybridCertificate_withAltKey() throws InvalidAlgorithmParameterException, CertificateException, NoSuchAlgorithmException, SignatureException, InvalidKeyException, OperatorCreationException, IOException, AlreadyExistException {
            // when
        ...
        @Test
        void createsCertificate_fromBase64Content() throws CertificateException, AlreadyExistException, NoSuchAlgorithmException {
            // when
        ...
        void throwsCertificateException_whenContentInvalid() {
            // when / then
            assertThatThrownBy(() -> certificateService.checkCreateCertificate("certificate")).isInstanceOf(CertificateException.class);
        }

        @Test
        void throwsNotFound_whenDeletingMissingCertificate() {
            // when / then
            assertThatThrownBy(() -> certificateService.deleteCertificate(SecuredUUID.fromString("abfbc322-29e1-11ed-a261-0242ac120002"))).isInstanceOf(NotFoundException.class);
        }
        ...
        @Test
        void uploadsCertificate_withCustomAttributes() throws CertificateException, AlreadyExistException, AttributeException, NotFoundException, IOException {
            // given
        ...
        void throwsNotUploaded_whenIgnoreTriggerMatches() throws Exception {
            ...
            assertThatThrownBy(() -> certificateService.uploadSync(request))
                    ...
                    .hasMessage("Certificate was not uploaded. See Certificate Uploaded Event History for more details.");
        }
        ...
        void deletesAllCertificates_whenBulkRemoving() {
            ...
            // then
            uuids.forEach(uuid ->
                    assertThatThrownBy(() -> certificateService.getCertificate(SecuredUUID.fromString(uuid))).isInstanceOf(NotFoundException.class)
            );
        }
        ...
        void skipsForbiddenCertificate_whenBulkRemoving() throws NotFoundException {
            ...
            Certificate forbiddenCert = aCertificate()
                    .withUuid(forbiddenUuid)
                    .withCommonName("forbiddenCert")
                    .build();
        ...
        @Test
        void downloadsCertificate_inAllFormatsAndEncodings() throws NotFoundException, CertificateException, IOException {
            // given
            CertificateContent content = certificateContentRepository.save(
                    aCertificateContent().withContent(DOWNLOADABLE_CERT_BASE64).build());
        ...
        @Test
        void reusesExistingKey_whenUploadingSameCertificate() throws com.otilm.api.exception.CertificateException, CertificateEncodingException, NotFoundException {
            // when
        ...
        @Test
        void throwsValidation_whenDeletingCertificateWithUser() throws CertificateEncodingException, com.otilm.api.exception.CertificateException {
            // when
            ...
            // then
            assertThatThrownBy(() -> certificateService.deleteCertificate(uuid)).isInstanceOf(ValidationException.class);
        }
        ...
        void clearsKeyAndAltKeyAssociations() {
            ...
            CertificateContent altContent = certificateContentRepository.save(
                    aCertificateContent().withContent("content").build());
    ...
    class Updates {
        ...
        @Test
        void rejectsObjectsUpdate_whenArchived() throws NotFoundException, CertificateOperationException, AttributeException {
        ...
        @Test
        void updatesRaProfile_whenNotArchived() throws NotFoundException, CertificateOperationException, CertificateException, IOException, AttributeException {
            // given
        ...
        @Test
        void propagatesConnectorMetadata_whenSwitchingRaProfile() throws NotFoundException, CertificateOperationException, CertificateException, IOException, AttributeException {
            // given
            stubAuthorityIdentify();
            SecuredUUID certificateSecuredUuid = certificate.getSecuredUuid();
            var request = aCertificateUpdateObjectsRequest().withRaProfileUuid(raProfile.getUuid().toString()).build();
        ...
        void throwsNotFound_whenCertificateMissingForRaProfile() {
            ...
            // when / then
            assertThatThrownBy(() -> certificateService.updateCertificateObjects(SecuredUUID.fromString("abfbc322-29e1-11ed-a261-0242ac120002"), uuidDto)).isInstanceOf(NotFoundException.class);
        }

        @Test
        void throwsNotFound_whenRaProfileMissing() {
            // given
            var uuidDto = aCertificateUpdateObjectsRequest().withRaProfileUuid("abfbc322-29e1-11ed-a261-0242ac120002").build();

            // when / then
            assertThatThrownBy(() -> certificateService.updateCertificateObjects(certificate.getSecuredUuid(), uuidDto)).isInstanceOf(NotFoundException.class);
        }

        @Test
        void updatesGroup_whenNotArchived() throws NotFoundException, CertificateOperationException, AttributeException {
            // given
            SecuredUUID certificateSecuredUuid = certificate.getSecuredUuid();
            var request = aCertificateUpdateObjectsRequest().withGroupUuids(List.of(group.getUuid().toString())).build();
        ...
        @Test
        void removesGroupAssociation_whenGroupAssigned() throws NotFoundException, CertificateOperationException, AttributeException {
            // given - a certificate already associated with the group
            SecuredUUID certificateSecuredUuid = certificate.getSecuredUuid();
            certificateService.updateCertificateObjects(certificateSecuredUuid,
                    aCertificateUpdateObjectsRequest().withGroupUuids(List.of(group.getUuid().toString())).build());
        ...
        void throwsNotFound_whenCertificateMissingForGroup() {
            // given
            var uuidDto = aCertificateUpdateObjectsRequest().withGroupUuids(List.of(group.getUuid().toString())).build();
        ...
        void throwsNotFound_whenGroupMissing() {
            // given
            var uuidDto = aCertificateUpdateObjectsRequest().withGroupUuids(List.of(UUID.randomUUID().toString())).build();
        ...
        @Test
        void updatesTrustedCaMark_whenNotArchived() throws CertificateOperationException, NotFoundException, AttributeException {
        ...
        @Test
        void clearsExistingOwner_whenBlankUuid() throws NotFoundException, CertificateOperationException, AttributeException {
        ...
        void throwsNotFound_whenCertificateMissingForOwner() {
            ...
            // when / then
            assertThatThrownBy(() -> certificateService.updateCertificateObjects(SecuredUUID.fromString("abfbc322-29e1-11ed-a261-0242ac120002"), dto)).isInstanceOf(NotFoundException.class);
        }
        ...
        void rejectsUserUpdate_whenCertificateArchived() {
            ...
            // when / then
            assertThatThrownBy(() -> certificateService.updateCertificateUser(certificateUuid, null)).isInstanceOf(ValidationException.class);
            certificate.setArchived(false);
            certificateRepository.save(certificate);
            assertThatCode(() -> certificateService.updateCertificateUser(certificateUuid, null)).doesNotThrowAnyException();
        }

        @Test
        void updatesGroups_whenBulkUpdating() throws CertificateException, com.otilm.api.exception.CertificateException, NotFoundException, IOException {
            // when
            Certificate certificateNew = certificateService.createCertificate(Base64.getEncoder().encodeToString(x509Cert.getEncoded()), CertificateType.X509);
    ...
    class EventHistory {
        ...
        void recordsFailedHistory_whenBulkRaProfileUpdateFails() throws NotSupportedException {
            ...
            assertThat(history.stream().anyMatch(h -> h.getEvent() == CertificateEvent.UPDATE_RA_PROFILE
                            && h.getStatus() == CertificateEventStatus.FAILED)).as("Failed bulk RA profile override must produce a FAILED UPDATE_RA_PROFILE history record; history: "
                            + history.stream().map(h -> h.getEvent() + "/" + h.getStatus()).toList()).isTrue();
        }
        ...
        void recordsFailedHistory_whenRaProfileUpdateFails() {
            ...
            // when / then
            assertThatThrownBy(() -> certificateService.updateCertificateObjects(certificateSecuredUuid, request)).isInstanceOf(CertificateOperationException.class);

            List<CertificateEventHistory> history = certificateEventHistoryRepository.findByCertificateOrderByCreatedDesc(certificate);
            assertThat(history.stream().anyMatch(h -> h.getEvent() == CertificateEvent.UPDATE_RA_PROFILE
                            && h.getStatus() == CertificateEventStatus.FAILED)).as("Failed RA profile update must produce a FAILED UPDATE_RA_PROFILE history record; history: "
                            + history.stream().map(h -> h.getEvent() + "/" + h.getStatus()).toList()).isTrue();
        }
        ...
        void recordsFailedHistory_whenDeletingCertificateWithUser() {
            ...
            // when / then
            assertThatThrownBy(() -> certificateService.deleteCertificate(certificateSecuredUuid)).isInstanceOf(ValidationException.class);

            List<CertificateEventHistory> history = certificateEventHistoryRepository.findByCertificateOrderByCreatedDesc(certificate);
            assertThat(history.stream().anyMatch(h -> h.getEvent() == CertificateEvent.DELETE
                            && h.getStatus() == CertificateEventStatus.FAILED)).as("Refused certificate deletion must produce a FAILED DELETE history record; history: "
                            + history.stream().map(h -> h.getEvent() + "/" + h.getStatus()).toList()).isTrue();
        }
    }
    ...
    class Relations {
        ...
        void rejectsAssociation_whenSuccessorIsFailed() {
            ...
            certificateRepository.save(certificate);
            var successorUuid = certificate.getUuid();
            var predecessorUuid = certificateRepository.save(
                    aCertificate().withState(CertificateState.ISSUED).build()).getUuid();
        ...
        void rejectsAssociation_whenSubjectTypesDiffer() {
            ...
            certificateRepository.save(certificate);
            var successorUuid = certificate.getUuid();
            var predecessorUuid = certificateRepository.save(aCertificate()
                    .withState(CertificateState.ISSUED)
        ...
        void resolvesRenewal_whenPredecessorSharesIdentityAndPublicKey() throws NotFoundException {
            ...
            certificateRepository.save(certificate);
            var predecessor = certificateRepository.save(aCertificate()
                    .withState(CertificateState.ISSUED)
        ...
        void resolvesReplacement_whenIdentityDiffers() throws NotFoundException {
            ...
            certificate.setSubjectDnNormalized("subjectDn");
            certificateRepository.save(certificate);
            var predecessor = certificateRepository.save(
                    aCertificate().withState(CertificateState.ISSUED).build());
        ...
        void removesAssociation_andRejectsRemovingItAgain() throws NotFoundException {
            ...
            // then
            assertThat(certificateService.getCertificateRelations(successorUuid).getPredecessorCertificates()).isEmpty();
        ...
        void ordersPredecessorAndSuccessorByNotBefore() throws NotFoundException {
            ...
            certificateRepository.save(certificate);
            var newer = certificateRepository.save(aCertificate()
                    .withState(CertificateState.ISSUED)
        ...
        void resolvesReplacement_whenReissuedWithoutChain() throws Exception {
            ...
            CertificateRelation relation = certificateRelationRepository
                    .findById(new CertificateRelationId(notIssued.getUuid(), certificate.getUuid())).orElseThrow();
            ...
            // then
            assertThat(firstPredecessorRelationType(notIssued.getUuid())).isEqualTo(CertificateRelationType.REPLACEMENT);
        }

        private CertificateRelationType relationTypeOf(UUID successorUuid, UUID predecessorUuid) throws NotFoundException {
            return certificateService.getCertificateRelations(successorUuid).getPredecessorCertificates().stream()
                    .filter(dto -> dto.getUuid().equals(predecessorUuid))
                    .findFirst().orElseThrow().getRelationType();
        }

        private CertificateRelationType firstPredecessorRelationType(UUID successorUuid) throws NotFoundException {
            return certificateService.getCertificateRelations(successorUuid)
                    .getPredecessorCertificates().getFirst().getRelationType();
        }
        ...
        private Certificate setUpRequestedIssueChain() throws Exception {
            ...
            commonIssuer.setCertificateContent(certificateContentRepository.save(
    ...
    private void downloadAndRecreate(CertificateFormat format, CertificateFormatEncoding encoding) throws NotFoundException, CertificateException, IOException {
        ...
        assertThatCode(() -> certificateService.createCertificate(certificateDownloadResponseDto.getContent(), CertificateType.X509)).doesNotThrowAnyException();
    }
